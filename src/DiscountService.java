public class DiscountService {
    public  double calculateDiscountPrice (Client client , double price) {// metoda do obliczenia rabatu ceny
    ...
    private  double applyDiscount(double price , double discount){ // metoda ktora ma zaaplikowac zniżkę do ceny
